...
def contents():
    ...
    return pd.DataFrame(
        [
            ...
            ("detect_mixed_data_anomalies", "Flag mixed-table anomalies (Mahalanobis + Isolation Forest)", "detect_mixed_data_anomalies(data, contamination=0.05, max_categories=15, headers=True)"),
        ],
