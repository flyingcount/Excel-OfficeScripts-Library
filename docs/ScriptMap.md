...
| Highlight Differences | `source/scripts/HighlightDifferences.ts` | Conditional fill on the selection | Green `=ROUND(Q11,2)=0` `#97FFC6`; red `=ROUND(Q$11,2)<>0` `#FFBDBD` (Q11 = top-left of the selection). |
