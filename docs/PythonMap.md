...
| `qq_norm` | `source/python-in-excel/functions/qq_norm.py` | `qq_norm("A1:A10")` | Normal Q-Q plot with Shapiro-Wilk and Anderson-Darling on the chart (attributes for other PY cells, or `plot=False` for a table). See [docs/python/qq_norm.md](python/qq_norm.md). |
