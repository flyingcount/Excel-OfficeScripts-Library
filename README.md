...
| `adf` | `source/python-in-excel/functions/adf.py` | Augmented Dickey-Fuller stationarity test |
| `acf_pacf` | `source/python-in-excel/functions/acf_pacf.py` | ACF and PACF plot (or lag table with `plot=False`) |
