...
3. Call a function, for example `describe("Table1[#All]")` or `stl_plot("A1:A24", 12)`. Call `contents()` for names, descriptions, and call signatures in that Initialization.
